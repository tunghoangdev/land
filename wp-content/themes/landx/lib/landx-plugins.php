...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/lib/plugins/iconize.zip',  // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ...
        array(
            ...
            'source'             => get_stylesheet_directory() . '/lib/plugins/perch-shortcodes.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
        ...
        array(
            ...
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '5.0.9', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
            'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        )
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'menu_title'                      => __( 'Install Plugins', 'landx' ),
            'installing'                      => __( 'Installing Plugin: %s', 'landx' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'landx' ),
            ...
            'return'                          => __( 'Return to Required Plugins Installer', 'landx' ),
            'plugin_activated'                => __( 'Plugin activated successfully.', 'landx' ),
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'landx' ), // %s = dashboard link.
