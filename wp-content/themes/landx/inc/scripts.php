...
function landx_scripts() {
	...
	wp_enqueue_style( 'bootstrap', THEMEURI . 'css/bootstrap.min.css', array(), null );
	...
	wp_register_script( 'landx-ajaxchimp', THEMEURI . 'js/jquery.ajaxchimp.js', array( 'jquery' ), '', false );
	wp_register_script( 'landx-ajaxchimplangs', THEMEURI . 'js/jquery.ajaxchimp.langs.js', array( 'jquery', 'landx-ajaxchimp' ), '', false );
	...
	wp_enqueue_script( 'landx-parallax', THEMEURI . '/js/parallax.min.js', array( 'jquery' ), '1.0', true );
	wp_enqueue_script( 'landx-localScroll', THEMEURI . 'js/jquery.localscroll-1.2.7-min.js', array( 'jquery' ), '', true );
	...
	wp_enqueue_script( 'landx-equalheights', THEMEURI . 'js/jquery.equalheights.min.js', array( 'jquery' ), '', true );
