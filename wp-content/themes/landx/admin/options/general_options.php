...
function landx_general_options( $options = array() ){
	...
	$options = array(
      ...
      array(
        ...
        'desc'        => 'Replace this with your own mailchimp post URL. This is a default mailchimp post url, you can set posturl for each page in <strong>Landx page settings > One page Settings.</strong> ',
