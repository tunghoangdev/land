...
function landx_meta_boxes() {
  ...
  $my_meta_box = array(
    ...
    array(
      ...
      array(
        ...
        'settings'    => array(
            array(
                ...
                array(
                        'id'          => 'display_button_icon',
                        'label'       => __( 'Display Button Icon', THEMENAME ),
                        'desc'        => '',
                        'std'         => 'off',
                        'type'        => 'on-off',        
                        'operator'    => 'and',        
                ...
                array(
                        'id'          => 'button_icon',
                        'label'       => __( 'Button Icon', THEMENAME ),
                        'desc'        => '',
                        'std'         => '',
                        'type'        => 'iconpicker',        
                        'operator'    => 'and',   
                        'condition'     => 'display_button_icon:is(on)'     
                      ),
                array(
                    'id'          => 'link_type',
                    'label'       => 'Link type',
	  ...
	  array(
        'id'          => 'onepage_mc_form_settings',
        'label'       => 'Onepage Form Settings',      
        'type'        => 'tab',
        'operator'    => 'and'
      ), 
	  array(
     ...
     array(
        'id'          => 'name_placeholder',
        'label'       => 'Default text in name field #1',
        'desc'        => '',
        'std'         => 'Your Name',
        'type'        => 'text',
        'class'       => '',
     ...
     array(
        ...
        'label'       => 'Default text in email field #2',
        'desc'        => '',
        'std'         => 'Your Email',
        'type'        => 'text',
        'class'       => '',
     ...
     array(
        ...
        'label'       => 'Default text in Phone field #3',
        'desc'        => '',
        'std'         => 'Phone number',
        'type'        => 'text',
        'class'       => '',
     ...
     array(
        'id'          => 'language',
        'label'       => 'Form Response Language',
        'desc'        => '<a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes" target="_blank">ISO-693-1 Language codes</a>',
        'std'         => 'en',
        'type'        => 'select',
        'class'       => '',
        'choices'     => array(
     ...
     array(
        'id'          => 'resp_0',
        'label'       => 'Response #1',
        'desc'        => 'e.g: We have sent you a confirmation email',
        'std'         => 'We have sent you a confirmation email',
        'type'        => 'text',
        'condition'   => 'form_display:is(on),form_field_settings:is(on),form_select_option:is(mailchimp),language:is(custom)',
        'operator'    => 'and'
      ),
     array(
        'id'          => 'resp_1',
        'label'       => 'Response #1',
        'desc'        => 'e.g: Please enter a value',
        'std'         => 'Please enter a value',
        'type'        => 'text',
        'condition'   => 'form_display:is(on),form_field_settings:is(on),form_select_option:is(mailchimp),language:is(custom)',
        'operator'    => 'and'
      ),
     array(
        'id'          => 'resp_2',
        'label'       => 'Response #2',
        'desc'        => 'e.g: An email address must contain a single @',
        'std'         => 'An email address must contain a single @',
        'type'        => 'text',
        'condition'   => 'form_display:is(on),form_field_settings:is(on),form_select_option:is(mailchimp),language:is(custom)',
        'operator'    => 'and'
      ),
     array(
        'id'          => 'resp_3',
        'label'       => 'Response #3',
        'desc'        => 'e.g: The domain portion of the email address is invalid (the portion after the @: )',
        'std'         => 'The domain portion of the email address is invalid (the portion after the @: )',
        'type'        => 'text',
        'condition'   => 'form_display:is(on),form_field_settings:is(on),form_select_option:is(mailchimp),language:is(custom)',
        'operator'    => 'and'
      ),
     array(
        'id'          => 'resp_4',
        'label'       => 'Response #4',
        'desc'        => 'e.g: The username portion of the email address is invalid (the portion before the @: )',
        'std'         => 'The username portion of the email address is invalid (the portion before the @: )',
        'type'        => 'text',
        'condition'   => 'form_display:is(on),form_field_settings:is(on),form_select_option:is(mailchimp),language:is(custom)',
        'operator'    => 'and'
      ),
     array(
        'id'          => 'resp_5',
        'label'       => 'Response #5',
        'desc'        => 'e.g: This email address looks fake or invalid. Please enter a real email address',
        'std'         => 'This email address looks fake or invalid. Please enter a real email address',
        'type'        => 'text',
        'condition'   => 'form_display:is(on),form_field_settings:is(on),form_select_option:is(mailchimp),language:is(custom)',
        'operator'    => 'and'
      ),
