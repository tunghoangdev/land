...
delete_option($GrOptionDbPrefix . 'getresponse_360_account');
delete_option($GrOptionDbPrefix . 'api_url');
delete_option($GrOptionDbPrefix . 'api_domain');
delete_option($GrOptionDbPrefix . 'web_forms');
?>