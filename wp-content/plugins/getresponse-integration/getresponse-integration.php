...
class Gr_Integration
{
	 ...
	 */
	var $PluginVersionSimpleFormat = '303';
								...
								<div id="comment_show"
									...
									<p>
										...
										<input class="GR_input2" type="text" name="comment_label"
										       value="<?php echo get_option($this->GrOptionDbPrefix . 'comment_label', __('Sign up to our newsletter!', 'Gr_Integration')) ?>"/>
									</p>
									...
									<div id="bp_registration_show"
										...
										<p>
											...
											<input class="GR_input2" type="text" name="bp_registration_label"
											       ...
											       value="<?php echo get_option($this->GrOptionDbPrefix . 'bp_registration_label', __('Sign up to our newsletter!', 'Gr_Integration')) ?>"/>
										</p>
									...
									<div id="checkout_show"
										...
										<p>
											...
											<input class="GR_input2" type="text" name="checkout_label"
											       value="<?php echo get_option($this->GrOptionDbPrefix . 'checkout_label', __('Sign up to our newsletter!', 'Gr_Integration')) ?>"/>
										</p>
	 ...
	 */
	function AddCheckboxToBpRegistrationPage()
	{
	 ...
	 */
	function addActivatedBpContactsToGr()
	{
		$emails = get_option($this->GrOptionDbPrefix . 'bp_registered_emails');
		if ( ! empty($emails))
		{
	 ...
	 * @return mixed
	 */
	function setGetResponse360domainToWebFormUrl($webforms, $api_domain)
	{
	 ...
	 * @return bool
	 */
	function getDateDiffWithCurrentDate($user_registered_date)
	{
	 ...
	 * Return list of active plugins
	 */
	function getGrPluginDetailsList()
	{
...
//{
//    $logFile = ABSPATH.'wordpress.log';
//
//    if (!is_file($logFile)) {
//        touch($logFile);
//    }
//
//    file_put_contents($logFile, PHP_EOL. date('Y-m-d H:i:s') .' - ' . $value, FILE_APPEND);
//}
